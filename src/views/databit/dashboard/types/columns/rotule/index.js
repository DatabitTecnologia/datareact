...
const ColumnsRotule = (props) => {
  ...
  useEffect(() => {
    ...
    let groupsserie = [];
    seriesfim.forEach((serie) => {
      let item = {};
      const valor = serie.data;
      const pos = valor.length;
      item['title'] = serie.name;
      item['cols'] = pos;
      groupsserie = groupsserie.concat(item);
    });
