...
import OportunidadeWorkflow from './workflow';
import OportunidadeUser from './user';
import StatusColor from './color';
import OportunidadeNotificacao from './notificacao';

const InforOportunidadeStatus = (props) => {
  ...
  return (
    <React.Fragment>
      <Infor
        ...
        termlist="Status de Oportunidades"
        moduleoption="4"
        address={false}
        primarykey="CODIGO"
        autoincrement={true}
      ...
      <Modal backdrop="static" size="xl" show={showworkflow} centered={true} onHide={handleCloseworkflow}>
        ...
        <ModalBody>
          <OportunidadeWorkflow statusselec={valuesfield[valuesname.indexOf('codigo')]}></OportunidadeWorkflow>
        </ModalBody>
      </Modal>
      <Modal backdrop="static" size="xl" show={showwuser} centered={true} onHide={handleCloseuser}>
        ...
        <ModalBody>
          <OportunidadeUser statusselec={valuesfield[valuesname.indexOf('codigo')]}></OportunidadeUser>
        </ModalBody>
      </Modal>
      <Modal backdrop="static" size="xl" show={showwnot} centered={true} onHide={handleClosenot}>
        ...
        <ModalBody>
          <OportunidadeNotificacao statusselec={valuesfield[valuesname.indexOf('codigo')]}></OportunidadeNotificacao>
        </ModalBody>
      </Modal>
...
export default InforOportunidadeStatus;
